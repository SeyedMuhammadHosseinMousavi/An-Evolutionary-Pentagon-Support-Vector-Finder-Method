...
[idx,C] = kmeans(ABCClusRes,3);
% K-NN labels Predict - k-nearest neighbor
% Create a classifier for 3 nearest neighbors
mdl = fitcknn(ABCClusRes,idx,'NumNeighbors',3,'Standardize',1);
% Predict labels 
...
OutlierRemFirst = rmoutliers([ABCClusRes label],'movmedian',3);
